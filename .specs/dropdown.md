...
status: implemented
spec_version: 1
checksum: 529992bf930795d08d6db253c9fd49595c4300e05b0b0fd6ddc55967660c8623
created: 2026-05-22
...
Collects or edits user input. Migrated from the existing implementation at `packages/webkit/src/components/webkit/inputs/dropdown/`.
...
| `autoFilterFocus` | `boolean` | `false` | no | auto Filter Focus. |
| `autoOptionFocus` | `boolean` | `false` | no | auto Option Focus. |
| `resetFilterOnHide` | `boolean` | `false` | no | reset Filter On Hide. |
| `appendTo` | `string` | `'body'` | no | append To. |
| `emptyMessage` | `string` | `'No available options'` | no | empty Message. |
| `filterIcon` | `string` | `'pi pi-search'` | no | filter Icon. |
| `scrollHeight` | `string` | `'14rem'` | no | scroll Height. |
