...
figma:
  ...
  node_id: 536:22
checksum: 70b84c22a6fb6886cae5c21b6d25e29bc81d06be86ff7cbe6a49ddf1fe83440b
created: 2026-07-22
...
| ------------- | -------------------------------------------------------------- | ---------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `options`     | `Array<{ value: unknown; label: string; disabled?: boolean }>` | `[]`       | false    | Options rendered inside the dropdown. When empty, the dropdown renders no options.                                                                                                                                                                                                       |
| `label`       | `string`                                                       | `''`       | false    | Text rendered inside the `Label`. When empty, the label row is omitted.                                                                                                                                                                                                                  |
| `placeholder` | `string`                                                       | `''`       | false    | Placeholder shown on the trigger when nothing is selected.                                                                                                                                                                                                                               |
...
| `size`        | `'small' \| 'medium' \| 'large'`                               | `'medium'` | false    | Size forwarded to the `Select` trigger. Heights: small=28px, medium=32px, large=40px.                                                                                                                                                                                                    |
| `multiple`    | `boolean`                                                      | `false`    | false    | Switches the component to multi-select; `modelValue` becomes an array.                                                                                                                                                                                                                   |
| `disabled`    | `boolean`                                                      | `false`    | false    | Disables the select and switches the helper to `kind="disabled"` (lock icon).                                                                                                                                                                                                            |
| `readonly`    | `boolean`                                                      | `false`    | false    | Marks the select read-only; value is visible but the dropdown is locked.                                                                                                                                                                                                                 |
| `required`    | `boolean`                                                      | `false`    | false    | Adds the `Required` tag to the `Label` and sets `aria-required` on the trigger.                                                                                                                                                                                                          |
| `invalid`     | `boolean`                                                      | `false`    | false    | Switches the helper to `kind="invalid"` and applies invalid border/ring tokens on the trigger.                                                                                                                                                                                           |
| `inputId`     | `string`                                                       | `''`       | false    | id for the trigger; consumed by `Label` via `for` and by `aria-describedby` wiring. When empty, the component auto-generates an id via `useId()`.                                                                                                                                        |
