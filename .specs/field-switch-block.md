...
Card-style boolean toggle with switch, label, description, and optional disabled helper badge inside a bordered block. Matches Figma FieldSwitchBlock (node 2027:7168).
