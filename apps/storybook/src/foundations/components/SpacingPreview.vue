...
<template>
  <div class="flex w-full flex-col gap-4 py-5 border-b border-subtle items-start last:border-b-0 sm:flex-row sm:gap-6">
    <div class="flex flex-col w-full gap-1.5 sm:w-80 sm:flex-none">
      ...
      >
        <code class="font-code text-[11px] bg-white/[0.07] border border-white/15 text-code px-1.5 py-0.5 rounded w-fit">{{ token.cssVar }}</code>
        <i
          :class="[
      ...
      <p class="text-[10px] text-muted m-0 font-code">Source: packages/theme/src/tokens/semantic/spacings.data.js</p>
    ...
    <div class="flex w-full flex-1">
      <div class="bg-surface border border-default rounded-lg p-4 min-h-[80px] flex items-center justify-center w-full">
        <div class="w-full" :style="{ padding: activeValue }">
          <div
