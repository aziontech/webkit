  ...
  <div class="overflow-x-auto rounded-lg border border-default">
    <table class="w-full border-collapse text-[13px]">
      <thead>
        <tr>
          <th
            class="px-3.5 py-2.5 text-left text-[10px] font-semibold uppercase tracking-wider border-b border-default text-muted whitespace-nowrap bg-black/15"
          >
            Token
          </th>
          <th
      ...
      <tbody>
        ...
        >
          <td
            class="px-3.5 py-2.5 border-b border-subtle align-middle text-default font-code text-xs font-semibold whitespace-nowrap"
          >
            {{ token.name }}
          </td>
          <td class="px-3.5 py-2.5 border-b border-subtle align-middle">
            ...
            >
              ...
              <i
                :class="[
                  'pi text-[10px] opacity-0 group-hover:!opacity-50',
                  isCopied(`${token.name}-css`) ? 'pi-check !text-success !opacity-100' : 'pi-copy'
                ]"
              />
            </button>
          </td>
          ...
          <td
            class="px-3.5 py-2.5 border-b border-subtle align-middle text-muted text-xs min-w-[200px]"
          >
            {{ token.description }}
          </td>
          <td class="px-3.5 py-2.5 border-b border-subtle align-middle">
