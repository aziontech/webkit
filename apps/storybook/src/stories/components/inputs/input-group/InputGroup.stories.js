...
const MIDDLE_INPUT =
  '<input placeholder="domain" class="w-full h-full bg-[var(--bg-canvas)] border-0 outline-none focus:ring-0 px-[var(--spacing-md)] text-label-sm text-[var(--text-muted)] placeholder:text-[var(--text-muted)]" />'
