...
## 6. Design Tokens (Foundations)

Storybook documents the token system under **Foundations → Design Tokens**:
...
Styling rules for webkit components: `.claude/docs/DESIGN.md`.

## 7. Where To Change What

- **Component source**: `packages/webkit/src`
- **Story source**: `apps/storybook/src/stories`
- **Theme and tokens**: `packages/theme/src/tokens`
