    ...
    template: /* html */ `
      <PageContainer>
        ...
        <section :class="SECTION_CLASS">
          <SectionHeader
            title="UI element"
            description="An abstracted application window: three status dots over one of three scenes — a centered glyph, a live copilot chat (a transcript scrolling between two fades, over a thinking row that stays put), or a website's header/hero/footer. Sits on the canvas rather than a surface, so it overrides the rim's fill layer. No small step — 32px leaves no room for a scene."
          />
          <div :class="GRID_CLASS">
