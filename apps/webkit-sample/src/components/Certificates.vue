<script setup>
  ...
  import { CERTIFICATES, certificateTypeOptions, EXPIRY_WINDOWS, matchExpiry } from '../lib/certificates'
  ...
  const create = () =>
    toast.info('Certificate', { description: 'Creating a certificate is disabled in the demo.' })
                ...
                >
                  <template #icon>
                    <span class="relative flex size-10 items-center justify-center">
                      ...
                      >
                        <i
                          class="ai ai-digital-certificates text-[1rem] leading-none text-[var(--text-default)]"
                          aria-hidden="true"
                        />
                      </span>
                    </span>
