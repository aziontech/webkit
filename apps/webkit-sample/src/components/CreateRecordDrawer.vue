          ...
          <Item.List>
            ...
            >
              <Item.Content>
                ...
                <Item.Description> Use @ to create a record for the root domain. </Item.Description>
              </Item.Content>
            ...
            >
              <Item.Content>
                ...
                <Item.Description>
                  Time-to-live a response can be cached for on a resolver server.
                </Item.Description>
              </Item.Content>
              <Item.Actions class="justify-end flex-1 max-w-[var(--container-3xs)]">
                <InputNumber
          ...
          <Item.List>
            ...
            >
              <Item.Content>
                ...
                <Item.Description>
                  Choose SIMPLE for standard DNS resolution, or WEIGHTED to distribute answers
                  across records by weight.
                </Item.Description>
              </Item.Content>
              <Item.Actions class="justify-end flex-1 max-w-[var(--container-3xs)]">
                <Select
            ...
            >
              <Item.Content>
                ...
                <Item.Description>
                  Relative weight (0–255) for this record within the weighted set.
                </Item.Description>
              </Item.Content>
              <Item.Actions class="justify-end flex-1 max-w-[var(--container-3xs)]">
                <InputNumber
