      ...
      <CardBox :padded="false">
        <template #content>
          <div class="flex flex-col gap-[var(--spacing-lg)] p-[var(--spacing-md)]">
            <p class="text-body-sm text-[var(--text-muted)]">
              Set the conditions to execute the rule. Add a variable, the comparison operator and,
              if prompted, an argument.
            </p>
    ...
    >
      <CardBox :padded="false">
        <template #content>
          <div class="flex flex-col gap-[var(--spacing-lg)] p-[var(--spacing-md)]">
            <p class="text-body-sm text-[var(--text-muted)]">
              Set the behaviors the rule should perform if the conditions defined in the criteria
              are met.
            </p>
