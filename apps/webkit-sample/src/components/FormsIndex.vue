<script setup>
  ...
  import { firstLevelDrawerExceptions, surfaceCounts, surfaceRules } from '../lib/surfaces'
  ...
  const groups = [
    ...
    },
    {
      id: 'in-context',
      title: 'Over the page',
      hint: 'A form that opens on top of what the user was already doing — a drawer beside the list, a dialog in front of it — and gives that context back when it closes.',
