  ...
  <AuthShell>
    ...
    <div class="grid flex-1 grid-cols-1 lg:grid-cols-2">
      ...
      <div
        ...
        :style="leadStyle"
        class="flex -translate-x-6 flex-col items-center justify-center gap-[var(--spacing-md)] px-[var(--spacing-xl)] py-[var(--spacing-xxl)] opacity-0 data-[entered]:translate-x-0 data-[entered]:opacity-100 motion-reduce:translate-x-0 motion-reduce:opacity-100 motion-reduce:transition-none"
      >
        <slot />
      </div>
