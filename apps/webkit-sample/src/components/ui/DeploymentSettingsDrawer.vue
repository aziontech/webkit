<script setup>
  ...
  //
  // The counterpart of the deploy drawer, and the reason the Deployments module has
  ...
  // deployment (see ui/DeployResourceDrawer.vue for the whole shape):
  //
  ...
  import { provisionedApplications } from '../../lib/provisioning'
