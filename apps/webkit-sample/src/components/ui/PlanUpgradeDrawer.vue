<script setup>
  ...
  import { chargeFor, leadPartsFor, planFor } from "../../plans.js";
        ...
        >
          ...
          <PanelContent>
            <!-- The two columns of the design. They stack below lg, where the
                 ...
                 right. -->
            <div class="grid grid-cols-1 gap-[var(--spacing-lg)] lg:grid-cols-[minmax(0,18rem)_minmax(0,1fr)] lg:gap-[var(--spacing-xl)]">
              ...
              >
                ...
                >
                  {{ lead.before
                  }}<span class="text-[var(--text-default)]">{{ lead.name }}</span
                  >{{ lead.after }}
                </p>
