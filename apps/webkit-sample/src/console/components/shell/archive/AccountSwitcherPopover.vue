<script setup>
  // ARCHIVED — not mounted anywhere. See ./README.md.
  //
  // The tenancy chain as three pills, each with its own popover. Replaced by
  // ../TenancySwitcher.vue, which puts the whole chain in one control. Kept whole
  // because it was retired for a design direction, not for a defect.
  //
