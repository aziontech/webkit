<script setup>
  ...
  const columns = [
    ...
    { accessorKey: 'sourceLabel', header: 'Source', enableSorting: true, minWidth: FIT_COLUMN },
    { accessorKey: 'endpointLabel', header: 'Endpoint', enableSorting: true, grow: 2 },
    { accessorKey: 'samplingLabel', header: 'Sampling', minWidth: FIT_COLUMN },
