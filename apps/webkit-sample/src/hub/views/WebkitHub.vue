<script setup>
  ...
  import AsciiAsterisk from '../components/AsciiAsterisk.vue'
  import ComponentGrid from '../components/ComponentGrid.vue'
  import HubAssets from '../components/HubAssets.vue'
  import HubChangelog from '../components/HubChangelog.vue'
  import HubFoundations from '../components/HubFoundations.vue'
  ...
  const CATEGORY_META = {
    ...
    code: {
      ...
      icon: 'pi pi-code',
      description:
        'Source and log surfaces — code blocks and log views for structured, monospaced content.'
    }
  }
  ...
  const hubSections = [
    {
      ...
      icon: 'pi pi-book',
      description:
        'Install the packages, wire the tooling, and ship your first token-driven component.'
    },
    {
