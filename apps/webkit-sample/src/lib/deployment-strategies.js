...
// the deploy drawer (../components/ui/DeployResourceDrawer.vue).
//
...
// visible in the deploy drawer's Select too — one store, or the drawer would keep
// offering a strategy the list says is gone.
const seeded = ref(
...
// strategy the operator authored has to survive a reload (the deploy drawer will
