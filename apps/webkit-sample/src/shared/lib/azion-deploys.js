...
// renders.
//
// Every deployment in this console is read on that page (see `deployPageRecord` in
// console/lib/data/deployments.js, which resolves any row to one shape). What differs is how
