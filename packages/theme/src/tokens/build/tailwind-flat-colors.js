 ...
 * ```javascript
 * import { flatColorsPlugin } from '@aziontech/theme/tokens/build/tailwind-flat-colors.js';
 *
 * export default {
...
export const flatColorsPlugin = plugin(({ addUtilities, addBase, theme }) => {
  // Add semantic text colors as root-level utilities
  const textColors = {
...
export default flatColorsPlugin;
