...
const shared = {
  ...
  'surface-150': tokenRef('primitives.gray.150'),
  'surface-200': tokenRef('primitives.gray.200'),
  'surface-250': tokenRef('primitives.gray.250'),
  ...
  'surface-750': tokenRef('primitives.gray.750'),
  'surface-775': tokenRef('primitives.gray.775'),
