<script setup lang="ts">
  ...
  import { buildRail, measureRail, RAIL_INDENT, RAIL_STROKE } from '../lib/toc-rail'
   ...
   */
  defineOptions({ name: 'DocOnThisPage' })
...
<template>
  ...
  >
    ...
    >
      <p class="m-0 text-overline-xs text-(--text-muted)">
        {{ title }}
      </p>
      ...
      <div class="relative">
        ...
        >
          ...
          />
          <path
            data-testid="doc-on-this-page__marker"
            :d="path"
            :stroke-width="RAIL_STROKE"
        ...
        <span
          aria-hidden="true"
          data-testid="doc-on-this-page__highlight"
    ...
    <nav
      ...
      data-testid="doc-on-this-page__group"
      class="flex flex-col gap-(--spacing-xs)"
    >
