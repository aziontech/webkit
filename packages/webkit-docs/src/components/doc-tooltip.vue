<script setup lang="ts">
   ...
   * shown when the reader hovers or focuses it. `<Tooltip>` in MDX.
   *
   ...
   *
   * The trigger is a `<button>`, never a bare `<span>`: a definition only
  ...
  /*
   * The panel is teleported to the end of <body>, so DOM order does NOT put it
  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        ref="panelRef"
        data-doc-chrome
        data-testid="doc-tooltip__panel"
