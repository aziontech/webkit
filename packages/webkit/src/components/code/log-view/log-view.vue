...
<template>
  <div
    ...
    :class="
      cn(
        'flex h-fit min-h-0 w-full min-w-0 max-w-full flex-col overflow-hidden data-[border]:rounded-(--shape-elements) data-[border]:border data-[border]:border-(--border-muted)',
        attrs.class
      )
    "
  >
