...
<template>
  <div
    ...
    :class="
      cn(
        'flex h-fit min-h-0 w-full min-w-0 max-w-full flex-col overflow-hidden data-[border]:rounded-[var(--shape-elements)] data-[border]:border data-[border]:border-[var(--border-muted)]',
        attrs.class
      )
    "
  >
