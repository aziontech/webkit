<script setup lang="ts">
  // Shipping a build to the edge: an active site on the right, the Azion mark on the left, and a stage pill
  // sitting over the seam between them.
  //
...
<template>
  ...
  >
    ...
    <IllustrationBox
      ...
      active
      icon="ai ai-azion"
      class="text-[var(--primary)] absolute left-[calc(50%-69px)] top-1/2 -translate-x-1/2 -translate-y-1/2"
    />
    ...
    <IllustrationPill
      ...
      icon="pi pi-hammer"
      label="Ship"
      class="absolute left-[37px] top-[47px]"
    />
  </span>
</template>
