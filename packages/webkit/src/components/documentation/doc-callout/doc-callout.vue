<script setup lang="ts">
   ...
   * right, and the pages proved it: the highlight kind and the tip kind were
   * used interchangeably for the same kind of sentence. Highlight is gone; that
   * sentence is written as a tip.
   *
   ...
   * 10% wash of the kind's own contrast token for the fill and its border token
