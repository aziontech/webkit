...
<template>
  <div
    ...
    class="flex shrink-0 items-center justify-center text-overline-sm text-(--text-muted) data-[orientation=horizontal]:w-full data-[orientation=horizontal]:flex-row data-[orientation=vertical]:h-full data-[orientation=vertical]:flex-col data-[labelled]:gap-(--spacing-xs) before:content-[''] before:flex-1 before:self-center before:border-(--border-default) after:content-[''] after:flex-1 after:self-center after:border-(--border-default) data-[orientation=horizontal]:before:border-t data-[orientation=horizontal]:after:border-t data-[orientation=vertical]:before:border-l data-[orientation=vertical]:after:border-l"
  >
    <span
      v-if="hasContent"
