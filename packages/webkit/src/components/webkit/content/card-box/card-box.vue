<script setup lang="ts">
  ...
  const headerClasses =
    'group flex min-h-14 shrink-0 items-center justify-between gap-[var(--spacing-2)] border-b border-[var(--border-default)] px-[var(--spacing-4)] py-[var(--spacing-3)]'
  ...
  const footerClasses =
    'flex min-h-14 shrink-0 items-center justify-center gap-[var(--spacing-3)] border-t border-[var(--border-default)] px-[var(--spacing-4)] py-[var(--spacing-3)]'
</script>
