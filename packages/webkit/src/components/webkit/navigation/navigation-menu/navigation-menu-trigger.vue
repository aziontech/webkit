<script setup lang="ts">
  ...
  interface Props {
    /** When set, renders as a top-level link instead of a disclosure trigger. */
    href?: string
    /** Marks the link as the current page. */
    active?: boolean
    /** Closes the menu after activating a link trigger. */
    closeOnClick?: boolean
    /** When true (default), submenu triggers render a native button element. */
    nativeButton?: boolean
    /** Polymorphic host element. */
    as?: string | object
  }
...
<template>
  <component
    ...
    :data-state="!isLink && itemOpen ? 'open' : 'closed'"
