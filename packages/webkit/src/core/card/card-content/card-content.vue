<script setup lang="ts">
  ...
  import Button from '../../../components/wip/site/button/button.vue'
  ...
  const baseBulletClasses =
    'before:bg-surface before:w-2 before:h-2 before:absolute before:block before:border before:border-subtle before:rounded-sm after:bg-surface after:w-2 after:h-2 after:absolute after:block after:border after:border-subtle after:rounded-sm'
